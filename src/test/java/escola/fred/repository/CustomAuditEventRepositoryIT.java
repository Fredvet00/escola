...
import escola.fred.config.audit.AuditEventConverter;
import escola.fred.domain.PersistentAuditEvent;
...
import static escola.fred.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
