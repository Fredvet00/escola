...
export class ProvaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.provaService
      ...
      .subscribe(
        (res: HttpResponse<IProva[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProva(): void {
    this.eventSubscriber = this.eventManager.subscribe('provaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProva[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
