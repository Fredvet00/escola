...
/**
 * REST controller for managing {@link escola.fred.domain.Curso}.
 */
@RestController
@RequestMapping("/api")
public class CursoResource {
     ...
     */
    @PutMapping("/cursos")
    public ResponseEntity<CursoDTO> updateCurso(@RequestBody CursoDTO cursoDTO) throws URISyntaxException {
